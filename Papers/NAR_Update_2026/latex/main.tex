...
%%
%% HENRY IS NOT FILLED IN. An ORCID name search restricted to Argonne returns
%% exactly one Christopher Henry, 0000-0001-8058-9123, listing Argonne,
%% Northwestern and Dayton -- consistent, but NOT confirmed by any publication
%% author list, and a wrong ORCID on a corresponding author misattributes the
%% work. Ask Chris, then uncomment:
...
%%
%% AFFILIATIONS 3, 5 and 6 are STALE and must be confirmed with the people
%% themselves: Noor was ETH Zurich in 2020 and has since moved, Beber was DTU,
%% and Giessmann's IGDORE listing is from 2023.
\author[1]{Andrew Freiburger}
\author[1]{Jos\'e P. Faria}
\author[1]{Janaka N. Edirisinghe\ORCID{0000-0003-2493-234X}}
\author[1]{Filipe Liu\ORCID{0000-0001-8701-2984}}
\author[12]{Cooper Taylor}
\author[1]{Vibhav Setlur}
\author[6]{Robert T. Giessmann}
\author[4]{Moritz E. Beber\ORCID{0000-0003-2406-1978}}
\author[3]{Elad Noor\ORCID{0000-0001-8776-4799}}
\author[10,11]{Vikas Upadhyay}
\author[5]{Mohit Anand}
\author[5]{Costas D. Maranas}
\author[8,9]{Sebastian Hu{\ss}\ORCID{0000-0003-0712-2986}}
\author[8,9]{Zoran Nikoloski\ORCID{0000-0003-2671-6763}}
\author[2]{Adam P. Arkin\ORCID{0000-0002-4999-2931}}
\author[7]{Robert W. Cottingham\ORCID{0000-0002-2775-3905}}
\author[2]{Elisha M. Wood-Charlson}
\author[1,$\dagger$]{Christopher S. Henry}
...
\address[2]{\orgdiv{Environmental Genomics and Systems Biology Division},
\orgname{Lawrence Berkeley National Laboratory},
\orgaddress{\postcode{94720}, \state{Berkeley, CA}, \country{USA}}}

\address[3]{\orgname{\TBD[Noor -- affiliation to confirm]}}

\address[4]{\orgname{\TBD[Beber -- affiliation to confirm]}}

\address[5]{\orgdiv{Department of Chemical Engineering},
\orgname{The Pennsylvania State University},
\orgaddress{\postcode{16802}, \state{University Park, PA}, \country{USA}}}

\address[6]{\orgname{\TBD[Giessmann -- affiliation to confirm]}}

\address[7]{\orgdiv{Biosciences Division},
\orgname{Oak Ridge National Laboratory},
\orgaddress{\postcode{37830}, \state{Oak Ridge, TN}, \country{USA}}}

%% 12 supplied by Sam (2026-09-11) on Cooper Taylor moving from Argonne. No
%% postcode given, so none is written -- every other address here carries one.
\address[12]{\orgdiv{College of Engineering, Computing and Applied Sciences},
\orgname{Clemson University},
\orgaddress{\state{Clemson, SC}, \country{USA}}}

%% 10 and 11 supplied by Vikas Upadhyay himself (2026-09-10) on moving from
%% Penn State; contact viku@illinois.edu. He holds both.
\address[10]{\orgdiv{NSF iBioFoundry},
\orgname{University of Illinois Urbana-Champaign},
\orgaddress{\postcode{61801}, \state{Urbana, IL}, \country{USA}}}

\address[11]{\orgdiv{Carl R. Woese Institute for Genomic Biology},
\orgname{University of Illinois Urbana-Champaign},
\orgaddress{\postcode{61801}, \state{Urbana, IL}, \country{USA}}}

%% 8 and 9 are transcribed from Hu{\ss} et al. 2022 (10.1111/tpj.15903) via
%% Crossref, so they are 2022-vintage and carry the same caveat as 3, 5 and 6:
%% confirm with the authors before submission.
\address[8]{\orgdiv{Systems Biology and Mathematical Modelling Group},
...
\address[9]{\orgdiv{Bioinformatics, Institute of Biochemistry and Biology},
...
\corresp[$\dagger$]{Corresponding author. \href{mailto:cshenry@anl.gov}{cshenry@anl.gov}}
...
%%-----------------------------------------------------------------------------
\abstract{\input{sections/M01_abstract}}
...
\input{sections/M02_introduction}

\section{Materials and Methods}
\input{sections/M03_methods_construction}
\input{sections/M05_methods_thermodynamics}
\input{sections/M06_methods_council_direction}
\input{sections/M07_methods_similarity_mapping}
\input{sections/M08_methods_distribution}

\section{Results}
\input{sections/M09_results_growth}
\input{sections/M10_results_structure_curation}
\input{sections/M11_results_thermodynamics}
\input{sections/M12_results_direction_sensitivity}
\input{sections/M13_results_mapping}

\input{sections/M14_discussion}
\input{sections/M15_data_availability}
\input{sections/M16_back_matter}
