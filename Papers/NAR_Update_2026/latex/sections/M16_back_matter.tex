...
\section{Author contributions} Contributions are given using the CRediT taxonomy, with degree of contribution in parentheses where it is not equal. S.M.D.S.: conceptualization (lead), methodology (lead), software (lead), formal analysis (lead), investigation (lead), data curation (lead), validation, visualization, writing --- original draft (lead), project administration. C.S.H.: conceptualization (equal), funding acquisition, supervision, writing --- review and editing. A.F.\ and J.P.F.: resources (equal), data curation, investigation, writing --- review and editing; J.P.F.\ also writing --- original draft. V.S.\ and C.T.: resources (equal), data curation, investigation. J.N.E.\ and F.L.: resources (supporting), software (supporting). R.T.G.: resources and data curation for the openTECR re-curation of the experimental measurements. E.N.\ and M.E.B.: software and resources for eQuilibrator. V.U., M.A.\ and C.D.M.: software and resources for dGPredictor. S.H.\ and Z.N.: software and resources for the atom-mapping workflow. A.P.A., R.W.C.\ and E.M.W.-C.: funding acquisition, supervision. All authors read and approved the final manuscript.
