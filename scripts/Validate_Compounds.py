...
if __name__ == "__main__":
    ...
    parser.add_argument('--show-details', help='show details on duplicates', action='store_true', dest='showDetails', default=False)
    ...
    with open(args.cpdfile, 'r') as handle:
        ...
        for line in handle:
            ...
            if len(fields) < len(fieldNames):
                ...
                continue
            cpd = { 'id': fields[0], 'name': fields[1], 'formula': fields[2], 'charge': int(fields[3]), 'lineno': lineno }
